...
//import static additional.TimerListener.brkcount;
    ...
    public class adminscreen {
        ...
        public static String img_flag = "Estonia";
        public static String img_flag2 = "Estonia";

        public static ImageIcon img = new ImageIcon("flags/"+img_flag+".png");
        public static ImageIcon img2 = new ImageIcon("flags/"+img_flag2+".png");
        // public static ImageIcon img = new ImageIcon("flags/"+img_flag+".png");
        public static JLabel rboxcountry12 = new JLabel("");
      ...
      //  public static JLabel con = new JLabel("");
        ...
        public static JLabel rexit1 = new JLabel("");
        public static JLabel bexit1 = new JLabel("");
        ...
        public static JLabel lblcountry = new JLabel("Estonia");
        ...
        public JPanel createContentPane() {
         ...
         img2 = new ImageIcon(new ImageIcon("flags/"+img_flag2+".png").getImage().getScaledInstance(100,100, Image.SCALE_DEFAULT));
...
// выбор страны
            ...
            boxUmpire1.setLocation(650, 600);
            ...
            boxUmpire2.setLocation(800, 600);
            ...
            boxUmpire3.setLocation(950, 600);
...
//  главная надпись Umpire List
            JLabel umpirelist = new JLabel("Judges list");
